...
<?php if(!is_single()): ?>
    <h1 id="home-link" ><a href="<?php echo home_url() ?>/#home" title="<?php get_bloginfo('name'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/wl-group.svg" alt="<?php get_bloginfo('name'); ?>" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/wl-group.png'"  /></a></h1>
 <?php endif; ?>
        <header id="header">
